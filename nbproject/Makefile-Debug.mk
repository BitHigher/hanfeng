...
${OBJECTDIR}/base/DataType.o: base/DataType.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/base/DataType.o base/DataType.cpp
...
${OBJECTDIR}/base/Parameter.o: base/Parameter.cpp 
	${MKDIR} -p ${OBJECTDIR}/base
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/base/Parameter.o base/Parameter.cpp

${OBJECTDIR}/base/ParameterMap.o: base/ParameterMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/base
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/base/ParameterMap.o base/ParameterMap.cpp
...
${OBJECTDIR}/io/AsciiFile.o: io/AsciiFile.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/io/AsciiFile.o io/AsciiFile.cpp
...
${OBJECTDIR}/kernel/Kernel.o: kernel/Kernel.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/kernel/Kernel.o kernel/Kernel.cpp
...
${OBJECTDIR}/machine/KernelMachine.o: machine/KernelMachine.cpp 
	${MKDIR} -p ${OBJECTDIR}/machine
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/machine/KernelMachine.o machine/KernelMachine.cpp
...
${OBJECTDIR}/multiclass/KNN.o: multiclass/KNN.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/multiclass/KNN.o multiclass/KNN.cpp

${OBJECTDIR}/regression/LeastAngleRegression.o: regression/LeastAngleRegression.cpp 
	${MKDIR} -p ${OBJECTDIR}/regression
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/regression/LeastAngleRegression.o regression/LeastAngleRegression.cpp

${OBJECTDIR}/regression/LeastSquaresRegression.o: regression/LeastSquaresRegression.cpp 
	${MKDIR} -p ${OBJECTDIR}/regression
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/regression/LeastSquaresRegression.o regression/LeastSquaresRegression.cpp

${OBJECTDIR}/regression/LinearRidgeRegression.o: regression/LinearRidgeRegression.cpp 
	${MKDIR} -p ${OBJECTDIR}/regression
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/regression/LinearRidgeRegression.o regression/LinearRidgeRegression.cpp
...
${OBJECTDIR}/test/test_classifier.o: test/test_classifier.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_classifier.o test/test_classifier.cpp

${OBJECTDIR}/test/test_clustering.o: test/test_clustering.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_clustering.o test/test_clustering.cpp

${OBJECTDIR}/test/test_features.o: test/test_features.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_features.o test/test_features.cpp

${OBJECTDIR}/test/test_file.o: test/test_file.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_file.o test/test_file.cpp

${OBJECTDIR}/test/test_labels.o: test/test_labels.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_labels.o test/test_labels.cpp
...
${OBJECTDIR}/test/test_vector.o: test/test_vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_vector.o test/test_vector.cpp
