...
${OBJECTDIR}/kernel/CustomKernel.o: kernel/CustomKernel.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/kernel/CustomKernel.o kernel/CustomKernel.cpp
...
${OBJECTDIR}/lib/Signal.o: lib/Signal.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/Signal.o lib/Signal.cpp
...
${OBJECTDIR}/test/test_regression.o: test/test_regression.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test_regression.o test/test_regression.cpp
